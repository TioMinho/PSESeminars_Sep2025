...
\input{theme/beamer_preamble.tex}	% Includes beamer-specific preamble configurations

% FRONT MATTER ----------------------------------------------------------------
\title[]{Predictive control and feedback equilibrium\\seeking for sustainable water resource recovery}
\subtitle[]{}
\author[O. Neto]{      
...
% SLIDES ----------------------------------------------------------------------
\input{slides/predictivecontrol.tex}
\input{slides/equilibriumseeking.tex}
