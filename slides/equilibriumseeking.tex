	...
	\begin{tcolorbox}[colframe=monokaiBG!33!white, colback=white, width=31em, rounded corners]
		...
		\begin{align*}
			...
			\underset{}{\text{subject to} } \quad
				& \clX{x[n{+}1]} = \clP{A}\clX{x[n]} + \clP{B_w}\clW{w[n]} + \textstyle\sum_{p} \clP{B_u^p} \clU{u[n]}   \\[-1.33ex]
				& ~~\clU{u^p[n]} = \clPU{K^p}(\clP{C}\clX{x[n]} + \clP{D_w}\clW{w[n]})   \\
...
% 	\vskip1em
% 	\begin{columns}
% 		\column[c]{10em} \includegraphics[width=\textwidth]{figs/NChains_Network}
% 		\column[c]{22em} \includegraphics[width=\textwidth]{figs/NChains_Convergence}
% 		\column[c]{16em} \includegraphics[width=\textwidth]{figs/NChains_Simulation}
% 	\end{columns}
% \end{center}
...
% 	\vskip1em
% 	\begin{columns}
% 		\column[c]{10em} \includegraphics[width=\textwidth]{figs/PGrid_Network}
% 		\column[c]{22em} \includegraphics[width=\textwidth]{figs/PGrid_Convergence}
% 		\column[c]{16em} \includegraphics[width=\textwidth]{figs/PGrid_Simulation}
% 	\end{columns}
% \end{center}
